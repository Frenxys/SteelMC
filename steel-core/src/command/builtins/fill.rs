...
fn execute_fill(
    ...
    let selection = match filter {
        ...
        FilterArgument::Predicate(name) => FillSelection::Predicate(
            context
                .block_predicate(name)
...
#[cfg(test)]
mod tests {
    use steel_registry::{test_support::init_test_registry, vanilla_game_rules};
    ...
    use crate::{
        ...
        entity::entities::{ItemEntity, PrimedTntEntity},
